...
export const OIL_MART_SALE_STATUS_META: Record<OilMartSaleStatus, OilMartSaleStatusMeta> = {
  ...
  QUOTATION_APPROVAL: { label: "Quotation approval", bg: "var(--mantine-color-orange-light)", border: "var(--mantine-color-orange-5)", badge: "orange", iconColor: "orange", icon: <IconFileCheck size={28} /> },
