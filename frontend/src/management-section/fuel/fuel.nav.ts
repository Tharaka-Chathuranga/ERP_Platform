...
export const NAV: NavItem[] = [
  ...
  { to: "/fuel/deliveries", label: "Deliveries", icon: IconTruckDelivery, color: "orange", description: "Supplier fuel deliveries & dip readings", group: "Fuel", requiredPermission: FUEL_VIEW },
